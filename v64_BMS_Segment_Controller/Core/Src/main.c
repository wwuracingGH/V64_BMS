...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
typedef enum { IDLE, CHARGING, RUNNING } BMSSTATES_T;
 ...
 * Temp data
 */
float cellTemps[2][NUMTHERMISTORS] = {{0},{0}};
...
int main(void)
{
  ...
  while(1) {
	  ...
	  case IDLE:
		  ...
		  //TMSampleTemps();
		  //TMGetTemps(&cellTemps);

		  /*
		   * Cells sitting idle on table
		   */
		  break;
	  case CHARGING:
		  /*
		   * If difference between two cells is too big, discharge the upper cell
		   */
		  break;
	  case RUNNING:
		  /*
